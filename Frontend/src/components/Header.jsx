      ...
      <div className="flex gap-3">
        {user ? (
          ...
          <>
            ...
            <Link to="/signup" className="px-4 py-1 bg-blue-600 text-white rounded hover:bg-blue-700">
              SIGNUP
            </Link>
          </>
        )}
